            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">fidelis@example.com</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-glow-primary/10">
          ...
          >
            ...
            <div>
              ...
              <textarea
                required
                rows={4}
                className="w-full px-4 py-3 rounded-lg bg-secondary border border-border/50 text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-glow-primary/50 transition-colors resize-none"
