      ...
      <div className="grid grid-rows-2 px-5 md:flex md:flex-col-2 md:gap-[5rem] items-center md:px-[5rem] md:pt-24">
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 rounded-1xl  blur-3xl" />
            <img
              src={heroImage}
              alt="Futuristic tech visual"
              className="relative w-[420px] h-[420px] md:w-[420px]  md:h-[420px] object-cover rounded-2xl border border-border/30 brightness-50"
            />
          </div>
        </motion.div>
      </div>
