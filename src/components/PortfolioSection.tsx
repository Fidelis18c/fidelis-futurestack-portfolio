        ...
        {projects.map((p, i) => (
          ...
          >
            <div className={`h-48 bg-gradient-to-br ${p.color} flex items-center justify-center relative`}>
              ...
              <ExternalLink className="text-glow-primary opacity-30 group-hover:opacity-60 transition-opacity" size={48} />
            </div>
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {p.stack.map((t) => (
                  <span
                    key={t}
                    className="text-xs font-medium px-3 py-1 rounded-full bg-glow-primary/10 text-glow-primary"
                  >
                    {t}
                  </span>
                ))}
