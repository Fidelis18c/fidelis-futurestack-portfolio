...
const services = [
  {
    ...
    desc: "Responsive, performant UIs with React, Next.js, TypeScript, and Tailwind CSS.",
  },
  {
    icon: Server,
  ...
  },
  {
    icon: Wrench,
    title: "DevOps & Tools",
    desc: "CI/CD pipelines, Docker, Git workflows, and cloud deployment on AWS & Vercel.",
  },
];

const techStack = [
  "React", "Next.js", "TypeScript", "Node.js", "Express", "PostgreSQL",
  "MongoDB", "Redis", "Docker", "Tailwind CSS", "Git", "AWS", "Prisma", "GraphQL",
];
...
const ServicesSection = () => (
  <section id="services" className="section-padding relative">
    <div className="container mx-auto">
      ...
      >
        <h3 className="font-heading font-semibold text-lg mb-6">Tech Stack</h3>
        <div className="flex flex-wrap justify-center gap-3">
          {techStack.map((t) => (
            <span
              key={t}
              className="text-sm font-medium px-4 py-2 rounded-lg bg-secondary border border-border/50 text-foreground hover:border-glow-primary/30 hover:bg-glow-primary/5 transition-all duration-300"
            >
              {t}
            </span>
          ))}
